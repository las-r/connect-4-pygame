# Connect 4 Pygame
A simple Connect 4 game written in Python using the Pygame library.
...
Yes, I copied and pasted this description from my [Lights Out](https://github.com/las-r/lights-out-pygame) game.
